...
<CENTER><TABLE BORDER=0>%0%</TABLE></CENTER><P>%1%")
...
ResDef(RDF_ADDITIONS_ALLOWED, RDF_MSG_BASE+24, "Additions allowed")
ResDef(RDF_DELETION_ALLOWED, RDF_MSG_BASE+25, "Deletion allowed")
ResDef(RDF_ICON_URL_LOCKED, RDF_MSG_BASE+26, "Icon URL locked")
ResDef(RDF_NAME_LOCKED, RDF_MSG_BASE+27, "Name locked")
ResDef(RDF_COPY_ALLOWED, RDF_MSG_BASE+28, "Copies allowed")
ResDef(RDF_MOVE_ALLOWED, RDF_MSG_BASE+29, "Moves allowed")
ResDef(RDF_WORKSPACE_POS_LOCKED, RDF_MSG_BASE+30, "Workspace position locked")
