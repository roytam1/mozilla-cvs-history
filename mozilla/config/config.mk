...
COMPILE_CFLAGS	= $(DEFINES) $(if $(findstring $(@F),$(notdir $(LIB_OBJS))),$(LIB_DEFINES)) $(INCLUDES) $(XCFLAGS) $(PROFILER_CFLAGS) $(DSO_CFLAGS) $(DSO_PIC_CFLAGS) $(CFLAGS) $(RTL_FLAGS) $(OS_COMPILE_CFLAGS) 
COMPILE_CXXFLAGS = $(DEFINES) $(if $(findstring $(@F),$(notdir $(LIB_OBJS))),$(LIB_DEFINES)) $(INCLUDES) $(XCFLAGS) $(PROFILER_CFLAGS) $(DSO_CFLAGS) $(DSO_PIC_CFLAGS)  $(CXXFLAGS) $(RTL_FLAGS) $(OS_COMPILE_CXXFLAGS)
