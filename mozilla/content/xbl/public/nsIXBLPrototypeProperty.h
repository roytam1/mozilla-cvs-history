...
{
public:
  static const nsIID& GetIID() { static nsIID iid = NS_IXBLPROTOTYPEPROPERTY_IID; return iid; }
  ...
  NS_IMETHOD InstallProperty(nsIScriptContext * aContext, nsIContent *aBoundElement, void * aScriptObject) = 0;
  NS_IMETHOD InitScriptObject(nsIScriptContext * aContext, nsIContent * aBoundElement, void ** aScriptObject) = 0;
};
