...
public:
  ...
  NS_IMETHOD InstallProperty(nsIScriptContext * aContext, nsIContent * aBoundElement, void * aScopeObject);
  NS_IMETHOD InitScriptObject(nsIScriptContext * aContext, nsIContent * aBoundElement, void ** aScriptObject);
...
protected:
  ...
  uintN mJSAttributes;
  nsIXBLPrototypeBinding * mPrototypeBinding; // weak reference back to the proto type binding which owns us.
