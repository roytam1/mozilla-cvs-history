...
NS_IMETHODIMP 
nsEventListenerManager::AddGroupedEventListener(const nsAReadableString& aType, 
                                                nsIDOMEventListener* aListener, 
                                                PRBool aUseCapture,
                                                nsIDOMEventGroup* aEvtGrp)
{
...
NS_IMETHODIMP 
nsEventListenerManager::RemoveGroupedEventListener(const nsAReadableString& aType, 
                                            nsIDOMEventListener* aListener, 
                                            PRBool aUseCapture,
                                            nsIDOMEventGroup* aEvtGrp)
{
