...
HTML_ATOM(output, "output")
HTML_ATOM(overflow, "overflow")
HTML_ATOM(p, "p")
HTML_ATOM(pattern, "pattern")
...
HTML_ATOM(repeatstart, "repeatstart")
HTML_ATOM(repeatmin, "repeatmin")
HTML_ATOM(repeatmax, "repeatmax")
HTML_ATOM(repetitiontype, "repetitiontype")
HTML_ATOM(repetitionindex, "repetitionindex")
HTML_ATOM(repetitiontemplate, "repetitiontemplate")
HTML_ATOM(repetitionblocks, "repetitionblocks")
HTML_ATOM(replace, "replace")
HTML_ATOM(required, "required")
HTML_ATOM(rev, "rev")
