...
NS_IMETHODIMP nsHTMLImageElement::OnStartContainer(imgIRequest *request, nsISupports *cx, gfxIImageContainer *image)
{
...
NS_IMETHODIMP nsHTMLImageElement::OnStopContainer(imgIRequest *request, nsISupports *cx, gfxIImageContainer *image)
{
  return NS_OK;
}
...
NS_IMETHODIMP nsHTMLImageElement::FrameChanged(gfxIImageContainer *container, nsISupports *cx, gfxIImageFrame *newframe, nsRect * dirtyRect)
{
  return NS_OK;
}
