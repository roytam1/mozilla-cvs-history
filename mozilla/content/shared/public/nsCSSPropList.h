...
#define CSS_PROP_SVGRESET(name_, id_, method_, hint_, datastruct_, member_, type_, iscoord_) CSS_PROP(name_, id_, method_, hint_, datastruct_, member_, type_, iscoord_)
#endif
...
#ifndef CSS_PROP_LIST_EXCLUDE_INTERNAL
CSS_PROP_SVGRESET(dominant-baseline, dominant_baseline, DominantBaseline, NS_STYLE_HINT_VISUAL, SVG, mDominantBaseline, eCSSType_Value, PR_FALSE)
...
CSS_PROP_SVG(text-anchor, text_anchor, TextAnchor, NS_STYLE_HINT_VISUAL, SVG, mTextAnchor, eCSSType_Value, PR_FALSE)
CSS_PROP_SVG(text-rendering, text_rendering, TextRendering, NS_STYLE_HINT_VISUAL, SVG, mTextRendering, eCSSType_Value, PR_FALSE)
#endif /* !defined (CSS_PROP_LIST_EXCLUDE_INTERNAL) */
#endif
