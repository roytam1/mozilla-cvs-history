    ...
    if ((NS_STYLE_FONT_SIZE_XXSMALL <= value) && 
      ...
      if (NS_STYLE_FONT_SIZE_LARGER == value) {
        ...
        if (index == 6 &&
          ...
          // 6 is the maximal answer from nsStyleUtil::FindNextLargerFontSize when eFontSize_CSS
          // paramater is passed; we reached the limit for CSS named sizes, let's apply a %age.
          // 150% is more or less the ratio between xx-large and x-large in all tables defined in
          // nsStyleUtil.cpp
        ...
        if (index == 0 &&
            aFont->mSize == aParentFont->mSize) {
          // 0 is the miminal answer from nsStyleUtil::FindNextLargerFontSize when eFontSize_CSS
          // paramater is passed; we reached the limit for CSS named sizes, let's apply a %age
