...
{
    LOG(("nsOnDataWritableEvent: HandleEvent [event=%x req=%x]",
        this, mRequest.get()));
...
//
NS_IMETHODIMP
nsStreamProviderProxy::OnStartRequest(nsIRequest *aRequest,
                                      nsISupports *aContext)
{
...
NS_IMETHODIMP
nsStreamProviderProxy::OnStopRequest(nsIRequest *aRequest,
                                     nsISupports *aContext,
                                     nsresult aStatus,
