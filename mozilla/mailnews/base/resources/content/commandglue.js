...
function GetMsgFolderFromURI(folderURI)
{
    ...
    if(folderResource)
        return folderResource.QueryInterface(Components.interfaces.nsIMsgFolder);
...
function GetServer(uri)
{
    ...
    try 
    {
        return GetMsgFolderFromUri(uri).server;
    }
    catch (ex) 
    {
...
function MsgToggleWorkOffline()
{
    ...
    offlineManager 
        = Components.classes["@mozilla.org/messenger/offline-manager;1"].getService(Components.interfaces.nsIMsgOfflineManager);
