...
nsCOMPtr<nsIMsgSend>        pMsgSend = nsnull;
  ...
  mimeConverter->DecodeMimeHeaderToCString(author.get(), nsnull, PR_FALSE,
                                           PR_TRUE,
  ...
  if (m_to)
  {
    mimeConverter->DecodeMimeHeaderToCString(m_to, nsnull, PR_FALSE, PR_TRUE, 
                                             getter_Copies(decodedString));
  ...
  if (m_bcc)
  {
    mimeConverter->DecodeMimeHeaderToCString(m_bcc, nsnull, PR_FALSE, PR_TRUE,
                                             getter_Copies(decodedString));
  ...
  if (m_fcc)
  {
    mimeConverter->DecodeMimeHeaderToCString(m_fcc, nsnull, PR_FALSE, PR_TRUE,
                                             getter_Copies(decodedString));
