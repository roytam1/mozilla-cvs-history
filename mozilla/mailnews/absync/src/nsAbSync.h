...
#define     SYNC_IS_USER      0x0100    // It's a user record
...
// For lists
  ...
  nsresult        DeleteMailingListEmailMembers();
  ...
  nsresult        GenerateMemberProtocolForChangedList(nsIAbCard *aCard, PRUint32 listIndex, nsString &protLine);
  ...
  nsresult        SaveListSyncMappingTable();
  ...
  nsresult        LocateListRecord(PRUint32 listID, syncListMappingRecord **result);
  nsresult        LocateListHistoryRecord(PRUint32 listID, syncListMappingRecord **result);
