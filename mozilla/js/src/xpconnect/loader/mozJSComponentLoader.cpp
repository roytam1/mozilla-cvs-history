...
#ifdef RHAPSODY
extern const char JSfileSizeValueName[]; // = "FileSize";
extern const char JSlastModValueName[]; // = "LastModTimeStamp";
extern const char JSxpcomKeyName[]; // = "Software/Mozilla/XPCOM";
#else
