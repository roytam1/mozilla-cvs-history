...
#ifndef nsFileTransfer_h__
#define nsFileTransfer_h__

#include "nsSimpleTransfer.h"
#include "mkgeturl.h"

class nsFileTransfer : public nsSimpleTransfer
{
public:
    nsFileTransfer(ActiveEntry* entry);
