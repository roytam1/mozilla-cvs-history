...
#ifndef _MOZSROAMINGCOPY_H_
#define _MOZSROAMINGCOPY_H_

#include "mozSRoamingProtocol.h"

class mozSRoamingCopy: public mozSRoamingProtocol
{
public:
    mozSRoamingCopy();
    virtual ~mozSRoamingCopy();
    nsresult Init(mozSRoaming* controller);
    nsresult Download();
    nsresult Upload();
