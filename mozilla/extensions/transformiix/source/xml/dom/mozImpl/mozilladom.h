...
class DOMImplementation : public MITREObject
{
  public:
    DOMImplementation();
    DOMImplementation(nsIDOMDOMImplementation* domImpl);
    ~DOMImplementation();

    void setNSObj(nsIDOMDOMImplementation* domImpl);

    virtual MBool hasFeature(DOMString feature, const DOMString& version) const;
...
class NodeList : public MITREObject
{
  public:
    NodeList();
    NodeList(nsIDOMNodeList* nodeList);
    ~NodeList();

    void setNSObj(nsIDOMNodeList* nodeList);

    virtual Node* item(Int32 index);
...
class NamedNodeMap : public MITREObject
{
  public:
    NamedNodeMap();
    NamedNodeMap(nsIDOMNamedNodeMap* namedNodeMap);
    ~NamedNodeMap();

    void setNSObj(nsIDOMNamedNodeMap* namedNodeMap);
...
{
  public:
    DocumentFragment(nsIDOMDocumentFragment* docFragment);
    ~DocumentFragment();
...
class Document : public Node
{
  ...
  //Document();
    ...
    //void setNSObj(nsIDOMDocument* document);
...
class Element : public Node
{
  ...
  //Element();
    ...
    //void setNSObj(nsIDOMElement* element);
...
class CharacterData : public Node
{
  ...
  protected:
    CharacterData(nsIDOMCharacterData* charData);
...
{
  public:
    CDATASection(nsIDOMCDATASection* cdataSection);
    ~CDATASection();
...
{
  public:
    Notation(nsIDOMNotation* notation);
    ~Notation();
...
{
  public:
    EntityReference(nsIDOMEntityReference* entityReference);
    ~EntityReference();
...
class DocumentType : public Node
{
  public:
    DocumentType();
    DocumentType(nsIDOMDocumentType* documentType);
    ~DocumentType();
