...
NS_DOM_JS_STUB_CONSTRUCTOR(XSLTProcessor)
NS_DOM_JS_STUB_CONSTRUCTOR(XPathEvaluator)
NS_DOM_JS_NATIVE_CONSTRUCTOR(XPathException)
NS_DOM_JS_NATIVE_CONSTRUCTOR(XPathExpression)
NS_DOM_JS_NATIVE_CONSTRUCTOR(XPathNSResolver)
NS_DOM_JS_NATIVE_CONSTRUCTOR(XPathResult)
