                                      ...
                                      int *aResult)
{
  long intValue;
  PRBool isValid =
    nsSchemaValidatorUtils::IsValidSchemaInteger(aNodeValue, PR_TRUE, &intValue);
    ...
    if (state == 0) {
      ...
      if (yearLength >= 4) {
        isValid = nsSchemaValidatorUtils::IsValidSchemaInteger(
                    Substring(buffStart, start), PR_TRUE, &yearNum);
      }
...
nsSchemaValidator::IsValidSchemaByte(const nsAString & aNodeValue, long *aResult)
{
  ...
  isValid = nsSchemaValidatorUtils::IsValidSchemaInteger(aNodeValue, PR_TRUE,
                                                         &byteValue);
