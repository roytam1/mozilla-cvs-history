...
//
// Called by -[AppShellDelegate handlePortMessage:] after mPort signals
// as a result of a CallFromNativeEvent call.  This method is public only
// because it needs to be called by that Objective-C fragment, and C++
// can't make |friend|s with Objective-C.
//
// public
void
...
// handlePortMessage:
//
// The selector called on the delegate object when nsAppShell::mPort is
// sent an NSPortMessage by CallFromNativeEvent.  Call into the nsAppShell
