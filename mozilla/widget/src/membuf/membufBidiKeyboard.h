...
#ifndef __membufBidiKeyboard
#define __membufBidiKeyboard
...
class membufBidiKeyboard : public nsIBidiKeyboard
{
public:
  NS_DECL_ISUPPORTS
  ...
  membufBidiKeyboard();
  virtual ~membufBidiKeyboard();

protected:
};


#endif // __membufBidiKeyboard
