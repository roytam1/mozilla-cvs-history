       ...
       case WM_ACTIVATE:
        ...
        case WM_FOCUSCHANGED:
          ...
          if (SHORT1FROMMP(mp2)) {
            ...
            // Get the nsWindow for this hwnd
            nsWindow *clientWnd = nsWindow::GetNSWindowPtr(hwndClient);
...
PRBool nsWindow::OnPaint()
{
   ...
   if( mContext && (mEventCallback || mEventListener))
   {
      ...
      HPS hpstemp;
      if (nsDragService::sDoingDrag)
        hpstemp = DrgGetPS(mWnd);
