...
////////////////////////////////////////////////////////////////////////////////
//
// PLUGIN-SIDE INTERFACE TO NETSCAPE COMMUNICATOR PLUGINS (NEW C++ API).
//
...
#include "npapi.h" // For backward compatibility
...
enum NPPluginError {
    NPPluginError_Base                      = NPERR_BASE,
    NPPluginError_NoError                   = NPERR_NO_ERROR,
    NPPluginError_GenericError              = NPERR_GENERIC_ERROR,
    NPPluginError_InvalidInstanceError      = NPERR_INVALID_INSTANCE_ERROR,
    NPPluginError_InvalidFunctableError     = NPERR_INVALID_FUNCTABLE_ERROR,
    NPPluginError_ModuleLoadFailedError     = NPERR_MODULE_LOAD_FAILED_ERROR,
    NPPluginError_OutOfMemoryError          = NPERR_OUT_OF_MEMORY_ERROR,
    NPPluginError_InvalidPluginError        = NPERR_INVALID_PLUGIN_ERROR,
    NPPluginError_InvalidPluginDirError     = NPERR_INVALID_PLUGIN_DIR_ERROR,
    NPPluginError_IncompatibleVersionError  = NPERR_INCOMPATIBLE_VERSION_ERROR,
    NPPluginError_InvalidParam              = NPERR_INVALID_PARAM,
    NPPluginError_InvalidUrl                = NPERR_INVALID_URL,
    NPPluginError_FileNotFound              = NPERR_FILE_NOT_FOUND,
    NPPluginError_NoData                    = NPERR_NO_DATA,
    NPPluginError_StreamNotSeekable         = NPERR_STREAM_NOT_SEEKABLE
};

#define NPCallFailed( code ) ((code) != NPPluginError_NoError)

enum NPPluginReason {
    NPPluginReason_Base         = NPRES_BASE,
    NPPluginReason_Done         = NPRES_DONE,
    NPPluginReason_NetworkErr   = NPRES_NETWORK_ERR,
    NPPluginReason_UserBreak    = NPRES_USER_BREAK,
