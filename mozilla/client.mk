...
NSPR_CO_TAG = MOZILLA_1_2a_RELEASE
PSM_CO_TAG = MOZILLA_1_2a_RELEASE #We will now build PSM from the tip instead of a branch.
NSS_CO_TAG = MOZILLA_1_2a_RELEASE
LDAPCSDK_CO_TAG = MOZILLA_1_2a_RELEASE
ACCESSIBLE_CO_TAG = MOZILLA_1_2a_RELEASE 
GFX2_CO_TAG = MOZILLA_1_2a_RELEASE
IMGLIB2_CO_TAG = MOZILLA_1_2a_RELEASE
BUILD_MODULES = all
