...
my($definesoption_file_name) = ":mozilla:config:mac:MozillaDebugDefinesOptions.h";
...
SetupDefaultBuildOptions(1, ":mozilla:dist:viewer_debug:", $definesoption_file_name);
