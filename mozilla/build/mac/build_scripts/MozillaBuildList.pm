...
sub BuildImglibProjects()
{
    ...
    BuildOneProject(":mozilla:modules:libimg:macbuild:libimg.mcp",              "libimg$D.$S", 1, $main::ALIAS_SYM_FILES, 0);
    BuildOneProject(":mozilla:modules:libimg:macbuild:gifdecoder.mcp",          "gifdecoder$D.$S", 1, $main::ALIAS_SYM_FILES, 1);
    BuildOneProject(":mozilla:modules:libimg:macbuild:pngdecoder.mcp",          "pngdecoder$D.$S", 1, $main::ALIAS_SYM_FILES, 1);
    BuildOneProject(":mozilla:modules:libimg:macbuild:jpgdecoder.mcp",          "jpgdecoder$D.$S", 1, $main::ALIAS_SYM_FILES, 1);
...
sub BuildSecurityProjects()
{
    ...
    if($main::options{psm2}) {
    	...
    	BuildOneProject(":mozilla:security:psm:macbuild:PersonalSecurityMgr.mcp","PSM$D.$S", 1, $main::ALIAS_SYM_FILES, 0);
    	BuildOneProject(":mozilla:extensions:psm-glue:macbuild:PSMGlue.mcp","PSMGlue$D.$S", 1, $main::ALIAS_SYM_FILES, 1);
...
#    BuildOneProject(":mozilla:gfx:macbuild:gfx.mcp",                            "gfx$D.$S", 1, $main::ALIAS_SYM_FILES, 0);
    ...
    BuildOneProject(":mozilla:modules:plugin:macbuild:plugin.mcp",              "plugin$D.$S", 1, $main::ALIAS_SYM_FILES, 1);
...
sub BuildExtensionsProjects()
{
    ...
    if ($main::options{ldap})
    {
        ...
        BuildOneProject(":mozilla:directory:c-sdk:ldap:libraries:macintosh:LDAPClient.mcp", "LDAPClient$D.$S", 1, $main::ALIAS_SYM_FILES, 0);
