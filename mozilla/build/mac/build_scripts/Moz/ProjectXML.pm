...
sub WriteXMLDocument($$$)
{
  ...
  if ($ide_version eq "4.0")    # Pro 5 is broken and can't import XML with <foo/> style tags
  {
...
sub SetAsStaticLibraryTarget($$$)
{
  ...
  #my(@obsolete_types) = (".shlb", ".lib", ".Lib", ".o", ".exp");
  my(@obsolete_files) = ("NSStdLibStubs", "InterfacesStubs");
