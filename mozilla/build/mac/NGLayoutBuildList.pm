...
sub Checkout()
{
    ...
    my($nsprpub_tag) = "Netscape_20001030_RELEASE";
    my($nss_tab) = "Netscape_20001030_SECURITY_MAC_RELEASE";
    my($psm_tag) = "Netscape_20001030_SECURITY_MAC_RELEASE";
    my($ldapsdk_tag) = "Netscape_20001030_RELEASE";
    my($sma_tag) = "Netscape_20001030_RELEASE";
