...
sub Checkout()
{
    ...
    my($nsprpub_tag) = "Netscape_20001031_RELEASE";
    my($nss_tab) = "Netscape_20001031_SECURITY_MAC_RELEASE";
    my($psm_tag) = "Netscape_20001031_SECURITY_MAC_RELEASE";
    my($ldapsdk_tag) = "Netscape_20001031_RELEASE";
    my($sma_tag) = "Netscape_20001031_RELEASE";
