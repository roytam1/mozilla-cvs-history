...
{  
 ...
 // }
  ...
  // ok make us dirty. This prevents any MarkDirtys under us from posting a reflow command.
  // This is needed because drag and drop forces reflows to be synchronous. And will put us in 
  // infinite loops unless we do this.
  ...
  mScrolling = PR_TRUE;
  // ok now that we are about to return mark us dirty this will prevent drag and drop from
