 ...
 * @access private
 */
	var $_adodb_column_types = array('C' => 'string',
	 											'X' => 'text',
	 											'D' => 'date',
	 											'T' => 'timestamp',
	 											'L' => 'boolean',
 ...
 */
	function describe(&$model) {
		...
		$fields = false;
		$cols = $this->_adodb->MetaColumns($this->fullTableName($model));
		...
		foreach($cols as $column) {
			...
			$fields[] = array('name' => $column->name, 'type' => $this->column($column->type), 'null' => $null);
		}
 ...
 */
	function limit($limit, $offset = null) {
		$return = parent::limit($limit, $offset = null);
		return $return;
	 }
