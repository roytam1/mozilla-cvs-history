...
<hr class="hide">
	<div id="footer">
        <p><a href="<?=$_SERVER['PHP_SELF']?>?application=firefox" class="switch-fx">Firefox Add-ons </a><a href="<?=$_SERVER['PHP_SELF']?>?application=thunderbird" class="switch-tb">Thunderbird Add-ons </a><a href="<?=$_SERVER['PHP_SELF']?>?application=mozilla" class="switch-suite">Mozilla Suite Add-ons </a></p>
