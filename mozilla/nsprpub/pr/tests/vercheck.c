...
/*
 * This release (4.6.9) is backward compatible with the
 * 4.0.x, 4.1.x, 4.2.x, 4.3.x, 4.4.x, 4.5.x, 4.6, 4.6.1, 4.6.2,
 * 4.6.3, 4.6.4, 4.6.5, 4.6.6, 4.6.7 and 4.6.8 releases.  It, of course,
...
static char *compatible_version[] = {
    ...
    "4.6.4", "4.6.5", "4.6.6", "4.6.7", "4.6.8", PR_VERSION
};
