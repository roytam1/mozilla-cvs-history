...
struct NS_GFX nsFont {
  ...
  enum {
    eGeneric_NONE         = -1,
    // Special
    eGeneric_moz_variable = 0, // for the default variable width font
    eGeneric_moz_fixed    = 1, // our special "use the user's fixed font"
    // CSS
    eGeneric_serif        = 2,
    eGeneric_sans_serif   = 3,
    eGeneric_monospace    = 4,
    eGeneric_cursive      = 5,
    eGeneric_fantasy      = 6
  };
  ...
  static void GenericIs(const nsString& aGeneric, PRInt32* aID);
};
