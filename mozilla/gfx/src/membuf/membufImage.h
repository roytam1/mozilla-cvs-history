...
#ifndef __membufImage_h__
#define __membufImage_h__
...
class membufImage: public nsIImage
{
public:
  membufImage();
  ~membufImage();
  ...
  // nsIImage
  virtual nsresult Init(PRInt32 aWidth,
                        PRInt32 aHeight,
                        PRInt32 aDepth,
...
protected:
    ...
    struct ImageData {
        ImageData() : bits(0), bpr(0), size(0), depth(0) { }
        ~ImageData() { delete[] bits; }
        PRUint8  *bits;
        PRUint32  bpr;
        PRUint32  size;
        PRUint8   depth;
    ...
    ImageData mImage;
    ImageData mAlphaImage;
};

#endif // __membufImage_h__
