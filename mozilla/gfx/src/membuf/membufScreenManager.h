...
#ifndef membufScreenManager_h___
#define membufScreenManager_h___

#include "nsIScreenManager.h"
#include "nsIScreen.h"
#include "nsCOMPtr.h"

class membufScreenManager : public nsIScreenManager
{
public:
    membufScreenManager();
    virtual ~membufScreenManager();
...
#endif  // membufScreenManager_h___
