...
#ifndef membufRenderingContext_h___
#define membufRenderingContext_h___
...
class membufRenderingContext : public nsRenderingContextImpl
{
public:
    membufRenderingContext();
    virtual ~membufRenderingContext();
    ...
    NS_IMETHOD DrawScaledTile(imgIContainer *aImage, nscoord aXOffset, nscoord aYOffset,
                              nscoord aTileWidth, nscoord aTileHeight, const nsRect * aTargetRect);
    NS_IMETHOD SetRightToLeftText(PRBool aIsRTL) { return NS_OK; }

protected:
    uint8* CompositeBitsInMemory(nsIImage* aImage,
                                 PRUint32 aSX, PRUint32 aSY, PRUint32 aSWidth, PRUint32 aSHeight,
                                 PRUint32 aDX, PRUint32 aDY, PRUint32 aDWidth, PRUint32 aDHeight);

    NS_IMETHOD RenderPostScriptDataFragment(const unsigned char*, long unsigned int);
    ...
    membufDrawingSurface mDrawingSurface;
};

#endif  // membufRenderingContext_h___
