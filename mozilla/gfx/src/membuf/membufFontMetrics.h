...
#ifndef membufFontMetrics_h__
#define membufFontMetrics_h__
...
class membufFontMetrics : public nsIFontMetrics
{
public:
    membufFontMetrics();
    virtual ~membufFontMetrics();
