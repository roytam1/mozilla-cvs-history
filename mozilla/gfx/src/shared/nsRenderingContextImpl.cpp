...
NS_IMETHODIMP nsRenderingContextImpl::DrawTile(gfxIImageContainer *aImage, gfx_coord aXOffset, gfx_coord aYOffset, const nsRect * aTargetRect)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
NS_IMETHODIMP nsRenderingContextImpl::DrawScaledTile(gfxIImageContainer *aImage, gfx_coord aXOffset, gfx_coord aYOffset, gfx_dimension aTileWidth, gfx_dimension aTileHeight, const nsRect * aTargetRect)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
