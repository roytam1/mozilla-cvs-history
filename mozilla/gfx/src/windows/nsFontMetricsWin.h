...
public:
  ...
  static PRUint16* GetFontCCMAP(HDC aDC, LPCTSTR aShortName, eFontType& aFontType, PRUint8& aCharset);
  static PRUint16* GetCCMAP(HDC aDC, LPCTSTR aShortName, eFontType* aFontType, PRUint8* aCharset);
