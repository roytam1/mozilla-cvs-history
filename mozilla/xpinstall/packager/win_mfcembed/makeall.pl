...
$gDirDistProduct      = "$topobjdir/dist/install-mfcembed";
...
MozPackager::system("perl -w $gDirPackager/makeuninstallini.pl $gDefaultProductVersion < $gDirPackager/win_mfcembed/uninstall.it > $gDirDistProduct/uninstall/uninstall.ini");

MozPackager::doCopy("$gDirPackager/win_mfcembed/defaults_info.ini", "$gDirDistProduct/uninstall");
...
MozPackager::system("perl -w $gDirPackager/makecfgini.pl $gDefaultProductVersion $gDirStageProduct $gDirDistProduct/xpi $inXpiURL < $gDirPackager/win_mfcembed/config.it > $gDirDistProduct/setup/config.ini");

# Make install.ini file
MozPackager::system("perl -w $gDirPackager/makecfgini.pl $gDefaultProductVersion $gDirStageProduct $gDirDistProduct/xpi $inXpiURL < $gDirPackager/win_mfcembed/install.it > $gDirDistProduct/setup/install.ini");
...
MozPackager::system("$gDirInstall/nsztool.exe ".
                    ...
                    MozPackager::makeWinPath("$gDirDistProduct/setup/*.*"). " ".
                    MozPackager::makeWinPath("$gDirDistProduct/xpi/*.*"));
