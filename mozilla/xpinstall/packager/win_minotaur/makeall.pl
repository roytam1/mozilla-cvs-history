...
$gProductNameGeneric           = "minotaur";
$gProductNamePretty            = "Minotaur";
$seiFileNameGeneric            = "nsinstall.exe";
$seiFileNameSpecific           = "$gProductNameGeneric-win32-installer.exe";
$seiStubRootName               = "$gProductNameGeneric-win32-stub-installer";
$seiFileNameSpecificStub       = "$seiStubRootName.exe";
$seuFileNameSpecific           = "$gProductNamePretty" ."Uninstall.exe";
$seuzFileNameSpecific          = "$gProductNameGeneric". "uninstall.zip";
...
$ENV{WIZ_nameProduct}          = "$gProductNamePretty";
$ENV{WIZ_nameProductNoVersion} = "$gProductNamePretty";
$ENV{WIZ_fileMainExe}          = "$gProductNamePretty.exe";
