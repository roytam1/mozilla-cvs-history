...
int xre_main(int argc, char* argv[], const nsXREAppData* aAppData)
{
  ...
  PRBool noRestart = PR_FALSE;
  {
...

    {
      ...
      if (componentsListChanged) {
        // Only now, after we've finished installing Extensions and their
        // components can we tell the dir provider to supply the list of 
        // components locations specified in "components.ini" when it is 
        // asked for the "ComsDL" enumeration. If we finalize installation
        // after this step, the Component Manager will already have loaded
        // components and we will be unable to replace the files because
        // they may be busy. 
