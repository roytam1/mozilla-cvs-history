                               ...
                               void** r_classObj)
{
  ...
  *r_classObj = NULL;
  ...
  // first check for the nsILocaleFactory interfaces
  ...
  else if (aClass.Equals(kMacLocaleFactoryCID)) {
		nsMacLocaleFactory *factory = new nsMacLocaleFactory();
    if (!factory) {
      rv = NS_ERROR_OUT_OF_MEMORY;
    }
    else {
    ...
    // let the nsLocaleMacFactory logic take over from here
    nsLocaleMacFactory* factory = new nsLocaleMacFactory(aClass);
    if (!factory) {
      rv = NS_ERROR_OUT_OF_MEMORY;
    }
    else {
...
static Components gComponents[] = {
  ...
  { "Mac locale", &kMacLocaleFactoryCID,
    NULL, },
