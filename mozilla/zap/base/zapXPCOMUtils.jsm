 ...
 * loader.
 * 
 * This is an old version of the file js/src/xpconnect/loader/XPCOMUtils.jsm.
 * Some zap components still rely on the old generateFactory API defined herein.
 * Once everything is converted to the new API, this file can be removed.
 *
...
EXPORTED_SYMBOLS = [ "zapXPCOMUtils" ];

debug("*** loading zapXPCOMUtils\n");
