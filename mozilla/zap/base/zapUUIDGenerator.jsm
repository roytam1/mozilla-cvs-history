// -*- moz-jssh-buffer-globalobj: "Components.utils.import('gre:zapUUIDGenerator.jsm', null)" -*-
/* ***** BEGIN LICENSE BLOCK *****
...
debug("*** loading zapUUIDGenerator.jsm\n");
...
// function toString() { return "[zapUUIDGenerator.jsm]"; }
