/* -*- Mode: javascript; tab-width: 2; indent-tabs-mode: nil; c-basic-offset: 2 moz-jssh-buffer-globalobj: "Components.utils.import('resource://gre/components/RDFUtils.jsm', null)" -*- */
/* ***** BEGIN LICENSE BLOCK *****
