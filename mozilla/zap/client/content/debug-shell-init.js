// -*- moz-jssh-buffer-globalobj: "getWindows()[0]" -*-
/* ***** BEGIN LICENSE BLOCK *****
...
// get rid of JSSh's welcome message and '>' prompts:
setProtocol("plain");

print("loading debug-shell-init.js...");

//**********************************************************************
// a startup script with some zap-specific debugging functions for JSSh
...
print("Type 'help()<return>' for available commands\n");
print("CTRL+UP/CTRL+DOWN move around in the command history\n");
print("Examples: 'inspect(getWindows()[0])<return>'\n");
