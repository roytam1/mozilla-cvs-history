...
NS_IMETHODIMP
zapG711RTPPacketizer::AddedToGraph(zapIMediaGraph *graph, const nsACString & id, nsIPropertyBag2 *node_pars)
{
  // set defaults:
  mPayloadType = 0;
...
NS_IMETHODIMP
zapG711RTPPacketizer::RemovedFromGraph(zapIMediaGraph *graph)
{
  return NS_OK;
}
