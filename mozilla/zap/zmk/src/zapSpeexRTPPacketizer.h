...
#ifndef __ZAP_SPEEXRTPPACKETIZER_H__
#define __ZAP_SPEEXRTPPACKETIZER_H__
...
// {BFB82FAE-DF32-4BBF-A0A8-417F04A846F7}
#define ZAP_SPEEXRTPPACKETIZER_CID                             \
  { 0xbfb82fae, 0xdf32, 0x4bbf, { 0xa0, 0xa8, 0x41, 0x7f, 0x04, 0xa8, 0x46, 0xf7 } }

#define ZAP_SPEEXRTPPACKETIZER_CONTRACTID ZAP_MEDIANODE_CONTRACTID_PREFIX "speex-rtp-packetizer"

class zapSpeexRTPPacketizer : public zapFilterNode
{
public:
  zapSpeexRTPPacketizer();
  ~zapSpeexRTPPacketizer();
