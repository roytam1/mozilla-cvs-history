...
#ifndef __ZAP_STUNTRANSPORT_H__
...
class zapIStunTransportSink;
class zapIStunAttributeFactory;
class zapIStunMessage2;
class zapTransportAddress;


class zapStunTransport : public zapIStunTransport
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_ZAPISTUNTRANSPORT
...
private:  
  ...
  nsTArray<PRUint16> mValidMethods;
};

#endif // __ZAP_STUNTRANSPORT_H__
