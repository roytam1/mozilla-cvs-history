 ...
 *                outer object. The object does not hold a reference to the
 *                outer object; it is the caller's responsibility to ensure
 *                that this pointer remains valid until the stub has been
 *                destroyed.
 * @param aResult A proxy interface. The stub object never destroys itself.
 *                It must be explicitly destroyed by calling
