...
//========================================================================================
{
    public:
    	...
    	friend NS_EXPORT nsInputStream& operator >> (nsInputStream&, nsPersistentFileDescriptor&);
    		// reads the data from a file
    	friend NS_EXPORT nsOutputStream& operator << (nsOutputStream&, const nsPersistentFileDescriptor&);
    	    // writes the data to a file
...
//========================================================================================
class NS_EXPORT nsDirectoryIterator
//  Example:
//
...
NS_EXPORT nsresult NS_FileSpecToIFile(nsFileSpec* fileSpec, nsILocalFile* *result);
