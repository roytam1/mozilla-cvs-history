...
extern NS_EXPORT void StartupSpecialSystemDirectory();
extern NS_EXPORT void ShutdownSpecialSystemDirectory();


// SEE ALSO:
//      mozilla/xpfe/appshell/public/nsFileLocations.h

class NS_EXPORT nsSpecialSystemDirectory : public nsFileSpec
{
...
}; // class NS_EXPORT nsSpecialSystemDirectory
