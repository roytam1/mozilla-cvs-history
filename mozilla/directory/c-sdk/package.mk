...
ifeq ($(OS_ARCH), WINNT)
	...
	$(NSINSTALL) $(LIBDIR)/$(NSS_LIBNAME).dll $(INSTDIR)/lib
	$(NSINSTALL) $(LIBDIR)/$(SSL_LIBNAME).dll $(INSTDIR)/lib
	$(NSINSTALL) $(LIBDIR)/$(PLC_BASENAME).dll $(INSTDIR)/lib
	$(NSINSTALL) $(LIBDIR)/$(PLDS_BASENAME).dll $(INSTDIR)/lib
	$(NSINSTALL) $(LIBDIR)/$(NSPR_BASENAME).dll $(INSTDIR)/lib
else
