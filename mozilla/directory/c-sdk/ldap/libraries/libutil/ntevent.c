 ...
 *
 *  event.c - Handles event logging and status reporting
 *	  to SC Manager for Directory Server on NT.
 *
 ******************************************************/
...
BOOL SlapdGetServerNameFromCmdline(char *szServerName, char *szCmdLine)
{
	BOOL bReturn = FALSE;
	char *szChar = NULL;
