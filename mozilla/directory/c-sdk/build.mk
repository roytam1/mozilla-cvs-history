...
ifeq ($(TARGETCPU),X86)
DLL_LDFLAGS+=-MACHINE:IX86 -ENTRY:_DllMainCRTStartup -STACK:0x10000,0x1000 -NODEFAULTLIB:OLDNAMES.lib
else
DLL_LDFLAGS+=-MACHINE:ARM -ENTRY:_DllMainCRTStartup -STACK:0x10000,0x1000 -NODEFAULTLIB:OLDNAMES.lib
endif
endif
