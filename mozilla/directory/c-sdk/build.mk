...
MACHINEOPTION=$(TARGETCPU)
endif
LINK_DLL=$(CYGWIN_WRAPPER) link $(DEBUG_LINK_OPT) /nologo /MAP /DLL /DEBUGTYPE:BOTH $(ML_DEBUG) \
        /SUBSYSTEM:$(SUBSYSTEM) $(LLFLAGS) -MACHINE:$(MACHINEOPTION) \
        -ENTRY:_DllMainCRTStartup -STACK:0x10000,0x1000 -NODEFAULTLIB:OLDNAMES.lib \
        $(EXTRA_LIBS) /out:"$@" $(OBJS)
endif
