...
class InstallDelete extends InstallObject {
	...
	int FILE_DOES_NOT_EXIST; //File cannot be deleted as it does not exist.
	int FILE_READ_ONLY;	// File cannot be deleted as it is read only.
	int FILE_IS_DIRECTORY;	// File cannot be deleted as it is a directory.
	int deleteStatus;
		...
		String inRelativeFileName) throws SoftUpdateException
	{
		...
		FILE_DOES_NOT_EXIST = SoftwareUpdate.FILE_DOES_NOT_EXIST;
		FILE_READ_ONLY = SoftwareUpdate.FILE_READ_ONLY;
		FILE_IS_DIRECTORY = SoftwareUpdate.FILE_IS_DIRECTORY;
