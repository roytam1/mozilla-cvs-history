...
"http://production-1.8-master.build.mozilla.org/pub/mozilla.org/thunderbird/nightly/2.0.0.13-candidates/rc1/unsigned/thunderbird-2.0.0.13.en-US.win32.installer.exe" =>
...
$milestone     = "thunderbird2.0.0.13-l10n";
