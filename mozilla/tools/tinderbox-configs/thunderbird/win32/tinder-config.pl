...
"http://stage-old.mozilla.org/pub/mozilla.org/thunderbird/nightly/2.0.0.22-candidates/build1/unsigned/thunderbird-2.0.0.22.en-US.win32.installer.exe" =>
...
"http://stage-old.mozilla.org/pub/mozilla.org/thunderbird/nightly/2.0.0.22-candidates/build1/unsigned/thunderbird-2.0.0.22.en-US.win32.zip" =>
...
$BuildTag = 'THUNDERBIRD_2_0_0_22_RELEASE';
...
$milestone     = "thunderbird2.0.0.22-l10n";
