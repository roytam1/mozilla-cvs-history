...
"http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0.10-candidates/build1/firefox-3.0.10.en-US.linux-i686.tar.bz2" => 
...
$BuildTag = 'FIREFOX_3_0_10_RELEASE';
