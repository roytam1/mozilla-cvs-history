...
$tbox_ftp_path = "/home/ftp/pub/firefox/nightly/experimental/linux-newref/hourly-builds";
$tbox_url_path = "http://ftp.mozilla.org/pub/mozilla.org/firefox/nightly/experimental/linux-newref/hourly-builds";
$milestone     = "trunk";
...
$ENV{MOZ_SYMBOLS_EXTRA_BUILDID} = 'newref';
