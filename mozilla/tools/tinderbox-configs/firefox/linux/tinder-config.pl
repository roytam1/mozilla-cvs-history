...
"http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.20-candidates/build1/firefox-2.0.0.20.en-US.linux-i686.tar.gz" => 
...
$BuildTag = 'FIREFOX_2_0_0_20_RELEASE';
...
$milestone     = "firefox2.0.0.20-l10n";
