...
"http://build-console.build.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.10-candidates/rc1/firefox-2.0.0.10.en-US.linux-i686.tar.gz" => 
...
$milestone     = "firefox2.0.0.10-l10n";
