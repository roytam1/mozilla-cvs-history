...
"http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.17-candidates/build2/firefox-2.0.0.17.en-US.linux-i686.tar.gz" => 
...
$BuildTag = 'FIREFOX_2_0_0_17_RELEASE';
...
$milestone     = "firefox2.0.0.17-l10n";
