...
$ConfigureOnly = 1;
%WGetFiles = (
# CONFIG: 	      "http://%stagingServer%/pub/mozilla.org/firefox/nightly/%version%-candidates/build%build%/firefox-%version%.en-US.linux-i686.tar.gz" => 
"http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.19-candidates/build2/firefox-2.0.0.19.en-US.linux-i686.tar.gz" => 
# CONFIG:	      "/%l10n_buildDir%/%l10n_buildPlatform%/firefox.tar.gz"
"//builds/tinderbox/Fx-Mozilla1.8-l10n-Release/Linux_2.4.21-53.EL_Depend/firefox.tar.gz"
	      );

# CONFIG: $BuildLocalesArgs = "ZIP_IN=%l10n_buildDir%/%l10n_buildPlatform%/firefox.tar.gz";
$BuildLocalesArgs = "ZIP_IN=/builds/tinderbox/Fx-Mozilla1.8-l10n-Release/Linux_2.4.21-53.EL_Depend/firefox.tar.gz";
...
$BuildTag = 'FIREFOX_2_0_0_19_RELEASE';
...
$milestone     = "firefox2.0.0.19-l10n";
