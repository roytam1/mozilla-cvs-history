...
"http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0.8-candidates/build2/firefox-3.0.8.en-US.linux-i686.tar.bz2" => 
...
$BuildTag = 'FIREFOX_3_0_8_RELEASE';
