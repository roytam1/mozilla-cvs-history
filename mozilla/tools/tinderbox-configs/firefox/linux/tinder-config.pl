...
$ConfigureOnly = 1;
%WGetFiles = (
	      "http://stage.mozilla.org/pub/mozilla.org/firefox/nightly/1.5.0.10-candidates/rc2/firefox-1.5.0.10.en-US.linux-i686.tar.gz",
...
#$BuildName = '';
$BuildTag = 'FIREFOX_1_5_0_10_RELEASE';
