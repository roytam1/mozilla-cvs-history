...
"http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.18-candidates/build1/firefox-2.0.0.18.en-US.linux-i686.tar.gz" => 
...
$BuildTag = 'FIREFOX_2_0_0_18_RELEASE';
...
$milestone     = "firefox2.0.0.18-l10n";
