...
"http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0rc3-candidates/build1/firefox-3.0.en-US.mac.dmg" => 
...
$BuildTag = 'FIREFOX_3_0rc3_RELEASE';
