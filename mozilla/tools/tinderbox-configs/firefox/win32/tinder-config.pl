...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0.11-candidates/build2/unsigned/firefox-3.0.11.en-US.win32.installer.exe' =>
...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0.11-candidates/build2/unsigned/firefox-3.0.11.en-US.win32.zip' =>
