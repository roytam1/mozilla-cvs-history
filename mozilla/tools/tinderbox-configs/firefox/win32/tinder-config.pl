...
'http://build-console.build.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.8-candidates/rc2/unsigned/firefox-2.0.0.8.en-US.win32.installer.exe' =>
...
'http://build-console.build.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.8-candidates/rc2/unsigned/firefox-2.0.0.8.en-US.win32.zip' =>
