...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0.14-candidates/build2/unsigned/firefox-3.0.14.en-US.win32.installer.exe' =>
...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0.14-candidates/build2/unsigned/firefox-3.0.14.en-US.win32.zip' =>
