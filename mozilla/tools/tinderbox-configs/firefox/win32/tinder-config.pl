...
'http://stage.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.6-candidates/rc2/unsigned/firefox-2.0.0.6.en-US.win32.installer.exe' =>
...
'http://stage.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.6-candidates/rc2/unsigned/firefox-2.0.0.6.en-US.win32.zip' =>
