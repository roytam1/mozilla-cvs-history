...
'http://build-console.build.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.10-candidates/rc1/unsigned/firefox-2.0.0.10.en-US.win32.installer.exe' =>
...
'http://build-console.build.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.10-candidates/rc1/unsigned/firefox-2.0.0.10.en-US.win32.zip' =>
