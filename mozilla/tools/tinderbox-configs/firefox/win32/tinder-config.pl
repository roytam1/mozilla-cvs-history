...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0.2-candidates/build6/unsigned/firefox-3.0.2.en-US.win32.installer.exe' =>
...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0.2-candidates/build6/unsigned/firefox-3.0.2.en-US.win32.zip' =>
