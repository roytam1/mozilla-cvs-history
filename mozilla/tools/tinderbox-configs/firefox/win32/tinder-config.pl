...
%WGetFiles = (
	      "http://stage.mozilla.org/pub/mozilla.org/firefox/nightly/1.5.0.10-candidates/rc1/firefox-1.5.0.10.en-US.win32.installer.exe" =>
	      "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-l10n-Release/WINNT_5.2_Depend/firefox-installer.exe",
	      "http://stage.mozilla.org/pub/mozilla.org/firefox/nightly/1.5.0.10-candidates/rc1/firefox-1.5.0.10.en-US.win32.zip" =>
