...
'http://stage.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.4-candidates/rc%rc%/unsigned/firefox-2.0.0.4.en-US.win32.installer.exe' =>
...
'http://stage.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.4-candidates/rc%rc%/unsigned/firefox-2.0.0.4.en-US.win32.zip' =>
