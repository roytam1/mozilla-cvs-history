#
## hostname: moz180-win32-tbox
## uname: WINNT MOZ180-WIN32-TB 5.2 3790 xx I386
#
...
$update_package = 1; # Turning off update for now.  It's not yet figured out on the 1.5.0.1 branch.
