...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.17-candidates/build1/unsigned/firefox-2.0.0.17.en-US.win32.installer.exe' =>
...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.17-candidates/build1/unsigned/firefox-2.0.0.17.en-US.win32.zip' =>
