...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.19-candidates/build2/unsigned/firefox-2.0.0.19.en-US.win32.installer.exe' =>
...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/2.0.0.19-candidates/build2/unsigned/firefox-2.0.0.19.en-US.win32.zip' =>
