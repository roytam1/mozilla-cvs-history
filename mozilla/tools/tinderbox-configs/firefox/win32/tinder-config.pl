...
%WGetFiles = (
	      "http://stage.mozilla.org/pub/mozilla.org/firefox/nightly/latest-mozilla1.8.0/firefox-%version%.en-US.win32.installer.exe" =>
	      "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-l10n/WINNT_5.2_Depend/firefox-installer.exe",
	      "http://stage.mozilla.org/pub/mozilla.org/firefox/nightly/latest-mozilla1.8.0/firefox-%version%.en-US.win32.zip" =>
	      "/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-l10n/WINNT_5.2_Depend/firefox.zip"
	      );

$BuildLocalesArgs = "ZIP_IN=/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-l10n/WINNT_5.2_Depend/firefox.zip WIN32_INSTALLER_IN=/cygdrive/c/builds/tinderbox/Fx-Mozilla1.8.0-l10n/WINNT_5.2_Depend/firefox-installer.exe";
