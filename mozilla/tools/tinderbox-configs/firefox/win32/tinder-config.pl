...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0.15-candidates/build1/unsigned/firefox-3.0.15.en-US.win32.installer.exe' =>
...
'http://stage-old.mozilla.org/pub/mozilla.org/firefox/nightly/3.0.15-candidates/build1/unsigned/firefox-3.0.15.en-US.win32.zip' =>
