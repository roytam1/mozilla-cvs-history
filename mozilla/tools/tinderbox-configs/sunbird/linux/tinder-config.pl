...
%WGetFiles = (
	      ...
	      "/builds/tinderbox/Sb-Mozilla1.8-l10n/Linux_2.4.21-32.0.1.EL_Depend/sunbird.tar.bz2"
	      );

$BuildLocalesArgs = "ZIP_IN=/builds/tinderbox/Sb-Mozilla1.8-l10n/Linux_2.4.21-32.0.1.EL_Depend/sunbird.tar.bz2";
