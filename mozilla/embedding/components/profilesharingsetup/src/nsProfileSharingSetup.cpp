...
NS_IMPL_THREADSAFE_ISUPPORTS1(nsProfileSharingSetup,
...
/* readonly attribute boolean sharingEnabled; */
NS_IMETHODIMP nsProfileSharingSetup::GetSharingEnabled(PRBool *aSharingEnabled)
{
