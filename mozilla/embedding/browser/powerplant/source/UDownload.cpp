...
NS_IMETHODIMP CDownload::Init(nsIURI *aSource, nsILocalFile *aTarget, const PRUnichar *aDisplayName, const PRUnichar *openingWith, PRInt64 startTime, nsIWebBrowserPersist *aPersist)
{
    try {
        mSource = aSource;
...
NS_IMETHODIMP CDownload::GetOpeningWith(PRUnichar * *aOpeningWith)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
