...
// HACK, HACK, HACK
// Put all this code here for now.
// Really, really, really needs to be in its own module.
////////////////////////////////////// BEGIN SINGLE-SIGN-ON SHIT //////////////////////////
#ifdef XP_MAC
...
si_GetUser(MWContext *context, char* URLName, Bool pickFirstUser) {
	...
	if ((user_count = XP_ListCount(user_ptr)) == 1) {
	    ...
	    users = (si_SignonUserStruct**)XP_ALLOC(user_count*sizeof(si_SignonUserStruct*));
	    list2 = list;
	    users2 = users;
