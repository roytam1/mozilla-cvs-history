...
NS_IMETHODIMP
nsRDFTreeDataModel::SetFirstVisibleItemIndex(PRUint32 index)
{
...
NS_IMETHODIMP
nsRDFTreeDataModel::GetItemCount(PRUint32& count) const
{
...
NS_IMETHODIMP
nsRDFTreeDataModel::GetNthItem(nsIDMItem*& pItem, PRUint32 n) const
{
