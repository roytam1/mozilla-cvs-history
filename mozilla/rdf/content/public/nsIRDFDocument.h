...
public:
  ...
  NS_IMETHOD SplitProperty(nsISupports* aResource, PRInt32* aNameSpaceID, nsIAtom** aTag) = 0;

  NS_IMETHOD AddElementForResource(nsISupports* aResource, nsIContent* aElement) = 0;

  NS_IMETHOD RemoveElementForResource(nsISupports* aResource, nsIContent* aElement) = 0;

  NS_IMETHOD GetElementsForResource(nsISupports* aResource, nsISupportsArray* aElements) = 0;
