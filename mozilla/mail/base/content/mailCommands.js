...
function ComposeMessage(type, format, folder, messageArray) 
{
  ...
  if (messageArray && messageArray.length > 0)
  {
    ...
    {	
      ...
      if (!identity || hintForIdentity.search(identity.email) < 0 && !customIdentity)
      {
