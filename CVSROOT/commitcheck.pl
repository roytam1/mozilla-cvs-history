...
$super{'205'} = ['wsharp%adobe.com','tierney%adobe.com','stejohns%adobe.com','shaver%mozilla.org','igor%mir2.org','dansmith%adobe.com','brendan%mozilla.org','edwsmith%adobe.com','jodyer%adobe.com',];
$mode{'202'} = 'Open';
$branch{'202'} = 'HEAD';
...
if (m:^http://hg\.mozilla\.org/tamarin-central/$:) {return '205';}
if (m:^http://hg\.mozilla\.org/tamarin-tracing/$:) {return '205';}
