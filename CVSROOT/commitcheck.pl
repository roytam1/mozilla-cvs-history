...
$blessed{'166'} = ['scott%scott-macgregor.org','pinkerton%netscape.com','noririty%jcom.home.ne.jp','kerz%mozillazine.org','ian%hixie.ch','dbaron%dbaron.org','bzbarsky%mit.edu','bryner%brianryner.com','brendan%mozilla.org','asa%mozilla.org','darin%meer.net',];
...
$blessed{'170'} = ['hyatt%mozilla.org','mkaply%us.ibm.com',];
