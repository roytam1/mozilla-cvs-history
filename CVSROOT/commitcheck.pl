...
$super{'205'} = ['wsharp%adobe.com','tierney%adobe.com','stejohns%adobe.com','shaver%mozilla.org','igor%mir2.org','edwsmith%adobe.com','brendan%mozilla.org','jodyer%adobe.com',];
$mode{'202'} = 'Open';
$branch{'202'} = 'HEAD';
