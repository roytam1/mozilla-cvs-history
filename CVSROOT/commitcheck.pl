...
$blessed{'70'} = ['timeless%mozdev.org','sayrer%gmail.com','jwalden%mit.edu','jst%mozilla.org','jruderman%hmc.edu','gerv%gerv.net','gavin%gavinsharp.com','dbaron%dbaron.org','daumling%adobe.com','crowder%fiverocks.com','cls%seawood.org','bzbarsky%mit.edu','bryner%brianryner.com','bratell%lysator.liu.se','benjamin%smedbergs.us','bclary%bclary.com','vladimir%pobox.com',];
