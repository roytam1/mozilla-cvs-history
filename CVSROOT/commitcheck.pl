...
$blessed{'166'} = ['jaggernaut%netscape.com','pinkerton%netscape.com','kerz%netscape.com','ian%hixie.ch','bryner%netscape.com','brendan%mozilla.org','asa%mozilla.org',];
$super{'166'} = ['hewitt%netscape.com','chanial%noos.fr','blakeross%telocity.com','ben%netscape.com','hyatt%netscape.com',];
$mode{'55'} = 'Open';
$branch{'55'} = 'HEAD';
...
$blessed{'70'} = ['timeless%mac.com','mike+mozilla%meer.net','cls%seawood.org','bratell%lysator.liu.se',];
