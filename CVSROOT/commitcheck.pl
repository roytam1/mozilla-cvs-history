...
$blessed{'70'} = ['timeless%mozdev.org','sayrer%gmail.com','jwalden%mit.edu','gavin%gavinsharp.com','dbaron%dbaron.org','daumling%adobe.com','jst%mozilla.org','cls%seawood.org','bzbarsky%mit.edu','bryner%brianryner.com','bratell%lysator.liu.se','benjamin%smedbergs.us','bclary%bclary.com',];
