...
$branch{'78'} = 'HEAD';
$fullname{'78'} = 'NSPR';
$blessed{'78'} = ['smfr%smfr.org','mkaply%us.ibm.com','julien.pierre.bugs%sun.com','gerv%gerv.net','christophe.ravel.bugs%sun.com',];
$super{'78'} = ['cls%seawood.org','bryner%brianryner.com','nelson%bolyard.com','wtchang%redhat.com','darin%meer.net',];
$mode{'163'} = 'Restricted';
