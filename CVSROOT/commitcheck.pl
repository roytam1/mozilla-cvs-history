...
$blessed{'166'} = ['scott%scott-macgregor.org','pinkerton%netscape.com','kerz%mozillazine.org','ian%hixie.ch','bryner%netscape.com','brendan%mozilla.org','asa%mozilla.org',];
