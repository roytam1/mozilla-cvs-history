...
$blessed{'166'} = ['pinkerton%netscape.com','ian%hixie.ch','bryner%netscape.com','brendan%mozilla.org',];
$super{'166'} = ['blakeross%telocity.com','ben%netscape.com','hyatt%netscape.com',];
$mode{'55'} = 'Open';
$branch{'55'} = 'HEAD';
...
$blessed{'164'} = ['bryner%netscape.com','brendan%mozilla.org','saari%netscape.com',];
$super{'164'} = ['beard%netscape.com','sfraser%netscape.com','pinkerton%netscape.com','hewitt%netscape.com','ben%netscape.com','hyatt%netscape.com',];
$mode{'146'} = 'Restricted';
...
$blessed{'59'} = ['seawood%netscape.com',];
