...
$blessed{'166'} = ['chanial%noos.fr','pinkerton%netscape.com','kerz%netscape.com','ian%hixie.ch','bryner%netscape.com','brendan%mozilla.org','asa%mozilla.org',];
