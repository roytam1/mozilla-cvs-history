...
$blessed{'166'} = ['scott%scott-macgregor.org','pinkerton%netscape.com','kerz%mozillazine.org','ian%hixie.ch','dbaron%dbaron.org','bryner%brianryner.com','brendan%mozilla.org','asa%mozilla.org','bzbarsky%mit.edu',];
$super{'166'} = ['varga%utcru.sk','mkaply%us.ibm.com','jaggernaut%netscape.com','hewitt%netscape.com','dean_tessman%hotmail.com','chanial%noos.fr','blakeross%telocity.com','ben%netscape.com','hyatt%mozilla.org',];
$mode{'55'} = 'Open';
$branch{'55'} = 'HEAD';
...
$blessed{'145'} = ['jgmyers%netscape.com','jaggernaut%netscape.com','cotter%netscape.com','cls%seawood.org','bryner%brianryner.com','alecf%flett.org','scc%mozilla.org',];
...
$blessed{'170'} = [];
$super{'170'} = ['kerz%mozillazine.org','bryner%brianryner.com','scott%scott-macgregor.org','bienvenu%netscape.com',];
$mode{'160'} = 'Open';
$branch{'160'} = 'HEAD';
$fullname{'160'} = 'String';
$mode{'169'} = 'Open';
