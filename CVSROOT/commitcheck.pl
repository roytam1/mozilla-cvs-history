...
$blessed{'146'} = ['sdagley%netscape.com','gordon%netscape.com','beard%netscape.com',];
...
$blessed{'59'} = [];
$super{'59'} = ['dmose%netscape.com','subbarao%computer.org','miodrag%netscape.com','mhein%netscape.com','leif%netscape.com','mcs%netscape.com',];
$mode{'103'} = 'Open';
$branch{'103'} = 'HEAD';
...
$blessed{'112'} = ['thesteve%netscape.com','waterson%netscape.com','warren%zodiacnetworks.com','waldemar%netscape.com','toshok%hungry.com','tague%netscape.com','sspitzer%netscape.com','slamm%netscape.com','shaver%mozilla.org','scc%mozilla.org','ramiro%eazel.com','phillip%netscape.com','petitta%netscape.com','mcafee%netscape.com','locka%iol.ie','kipp%netscape.com','kandrot%netscape.com','jj%netscape.com','jim_nance%yahoo.com','Jerry.Kirk%Nexwarecorp.com','jar%netscape.com','friedman%splode.com','endico%mozilla.org','dougt%netscape.com','donm%bluemartini.com','dmose%mozilla.org','dbaron%fas.harvard.edu','curt%scruznet.com','cls%seawood.org','bsharma%netscape.com','bryner%uiuc.edu','briano%netscape.com','braddr%puremagic.com','blizzard%redhat.com','attinasi%netscape.com','amasri%netscape.com','alla%lysator.liu.se',];
...
$branch{'78'} = 'HEAD';
$fullname{'78'} = 'NSPR';
$blessed{'78'} = ['sdagley%netscape.com','gordon%netscape.com','cls%seawood.org','beard%netscape.com',];
