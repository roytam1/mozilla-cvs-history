...
$super{'166'} = ['varga%nixcorp.com','mkaply%us.ibm.com','jag%tty.nl','hewitt%netscape.com','chanial%noos.fr','bryner%brianryner.com','blakeross%telocity.com','ben%bengoodger.com','hyatt%mozilla.org',];
$mode{'55'} = 'Open';
$branch{'55'} = 'HEAD';
...
$blessed{'146'} = ['sfraser%netscape.com','sdagley%netscape.com','mkaply%us.ibm.com','lpham%netscape.com','jje%mac.com','granrose%netscape.com',];
...
$super{'170'} = ['kerz%mozillazine.org','hyatt%mozilla.org','bryner%brianryner.com','bienvenu%nventure.com','scott%scott-macgregor.org',];
$mode{'160'} = 'Open';
$branch{'160'} = 'HEAD';
$fullname{'160'} = 'String';
$mode{'169'} = 'Open';
