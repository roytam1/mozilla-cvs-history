...
$blessed{'166'} = ['pinkerton%netscape.com','kerz%mozillazine.org','ian%hixie.ch','bryner%netscape.com','brendan%mozilla.org','asa%mozilla.org',];
$super{'166'} = ['ben%netscape.com','varga%netscape.com','mkaply%us.ibm.com','jaggernaut%netscape.com','hewitt%netscape.com','dean_tessman%hotmail.com','chanial%noos.fr','blakeross%telocity.com','hyatt%mozilla.org',];
$mode{'55'} = 'Open';
$branch{'55'} = 'HEAD';
...
$blessed{'145'} = ['jgmyers%netscape.com','jaggernaut%netscape.com','cotter%netscape.com','cls%seawood.org','bryner%netscape.com','alecf%netscape.com','scc%mozilla.org',];
