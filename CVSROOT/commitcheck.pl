...
$blessed{'70'} = ['sayrer%gmail.com','timeless%mozdev.org','jwalden%mit.edu','jst%mozilla.org','jruderman%hmc.edu','gavin%gavinsharp.com','dbaron%dbaron.org','daumling%adobe.com','cls%seawood.org','bzbarsky%mit.edu','bryner%brianryner.com','bratell%lysator.liu.se','benjamin%smedbergs.us','bclary%bclary.com',];
...
$blessed{'205'} = ['cpeyer%adobe.com','ssubrama%adobe.com',];
$super{'205'} = ['igor.bukanov%gmail.com','edwsmith%adobe.com','brendan%mozilla.org','dansmith%adobe.com','shaver%mozilla.org','stejohns%adobe.com','tierney%adobe.com','wsharp%adobe.com',];
$mode{'202'} = 'Open';
$branch{'202'} = 'HEAD';
