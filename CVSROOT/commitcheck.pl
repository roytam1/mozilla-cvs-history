...
$super{'166'} = ['varga%utcru.sk','mkaply%us.ibm.com','jaggernaut%netscape.com','hewitt%netscape.com','dean_tessman%hotmail.com','chanial%noos.fr','blakeross%telocity.com','ben%bengoodger.com','hyatt%mozilla.org',];
$mode{'55'} = 'Open';
$branch{'55'} = 'HEAD';
