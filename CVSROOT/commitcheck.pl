...
$blessed{'166'} = ['pinkerton%netscape.com','kerz%netscape.com','ian%hixie.ch','hewitt%netscape.com','chanial%noos.fr','bryner%netscape.com','brendan%mozilla.org','asa%mozilla.org',];
