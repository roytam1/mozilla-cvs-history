...
$blessed{'70'} = ['jwalden%mit.edu','gavin%gavinsharp.com','dbaron%dbaron.org','daumling%adobe.com','cls%seawood.org','bzbarsky%mit.edu','bryner%brianryner.com','bratell%lysator.liu.se','benjamin%smedbergs.us','bclary%bclary.com','timeless%mozdev.org',];
