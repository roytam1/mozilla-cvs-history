...
$blessed{'146'} = ['smfr%smfr.org','mkaply%us.ibm.com','julien.pierre.bugs%sun.com','dbaron%dbaron.org','gerv%gerv.net',];
...
$branch{'78'} = 'HEAD';
$fullname{'78'} = 'NSPR';
$blessed{'78'} = ['smfr%smfr.org','julien.pierre.bugs%sun.com','christophe.ravel.bugs%sun.com','gerv%gerv.net',];
