...
$blessed{'145'} = [];
$super{'145'} = ['wtc%netscape.com','sonmi%netscape.com','roeber%netscape.com','nelsonb%netscape.com','mcgreer%netscape.com','larryh%netscape.com','javi%netscape.com','chrisk%netscape.com','thayes%netscape.com','relyea%netscape.com','ddrinan%netscape.com','nicolson%netscape.com',];
$mode{'151'} = 'Open';
$branch{'151'} = 'HEAD';
