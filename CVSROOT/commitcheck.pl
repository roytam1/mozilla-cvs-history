...
$blessed{'164'} = ['saari%netscape.com','brendan%mozilla.org','bryner%netscape.com',];
$super{'164'} = ['sfraser%netscape.com','pinkerton%netscape.com','hewitt%netscape.com','ben%netscape.com','hyatt%netscape.com',];
$mode{'146'} = 'Restricted';
