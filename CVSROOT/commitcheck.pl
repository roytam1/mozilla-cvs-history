...
$blessed{'146'} = ['smfr%smfr.org','mkaply%us.ibm.com','julien.pierre.bugs%sun.com','gerv%gerv.net','dbaron%dbaron.org','alexei.volkov.bugs%sun.com',];
$super{'146'} = ['cls%seawood.org','bryner%brianryner.com','wtchang%redhat.com','nelson%bolyard.com','darin%meer.net',];
$mode{'96'} = 'Open';
$branch{'96'} = 'HEAD';
...
$blessed{'70'} = ['timeless%mozdev.org','jwalden%mit.edu','gavin%gavinsharp.com','dbaron%dbaron.org','daumling%adobe.com','cls%seawood.org','sayrer%gmail.com','bzbarsky%mit.edu','bryner%brianryner.com','bratell%lysator.liu.se','benjamin%smedbergs.us','bclary%bclary.com',];
...
$branch{'78'} = 'HEAD';
$fullname{'78'} = 'NSPR';
$blessed{'78'} = ['alexei.volkov.bugs%sun.com','smfr%smfr.org','mkaply%us.ibm.com','julien.pierre.bugs%sun.com','gerv%gerv.net','christophe.ravel.bugs%sun.com',];
$super{'78'} = ['cls%seawood.org','bryner%brianryner.com','wtchang%redhat.com','nelson%bolyard.com','darin%meer.net',];
$mode{'163'} = 'Restricted';
...
$fullname{'138'} = 'Rhino';
$blessed{'138'} = [];
$super{'138'} = ['rogerl33%aol.com','nboyd%atg.com','mike%meer.net','szegedia%freemail.hu','igor.bukanov%gmail.com',];
$mode{'145'} = 'Restricted';
$branch{'145'} = 'HEAD';
$fullname{'145'} = 'security';
$blessed{'145'} = ['douglas%stebila.ca','nkwan%redhat.com','jgmyers%speakeasy.net','gerv%gerv.net','cls%seawood.org','bryner%brianryner.com',];
