...
$blessed{'166'} = ['pinkerton%netscape.com','kerz%netscape.com','ian%hixie.ch','chanial%noos.fr','bryner%netscape.com','brendan%mozilla.org','asa%mozilla.org','hewitt%netscape.com',];
