...
$super{'145'} = ['jamie-bugzilla%jampee.com','tfox%netscape.com','sandeep.konchady%sun.com','neil.williams%sun.com','kaie%kuix.de','hanfei.yu%sun.com','glen.beasley%sun.com','christophe.ravel.bugs%sun.com','alexei.volkov.bugs%sun.com','wtchang%redhat.com','relyea%netscape.com','nelsonb%netscape.com','julien.pierre.bugs%sun.com',];
$mode{'151'} = 'Open';
$branch{'151'} = 'HEAD';
