...
$blessed{'190'} = ['vladd%bugzilla.org','olav%bkor.dhs.org','ghendricks%novell.com',];
$super{'190'} = ['myk%mozilla.org','mkanat%bugzilla.org','lpsolit%gmail.com','justdave%bugzilla.org',];
$mode{'204'} = 'Closed';
...
$branch{'78'} = 'HEAD';
$fullname{'78'} = 'NSPR';
$blessed{'78'} = ['kaie%kuix.de','sspitzer%mozilla.org','mozilla%weilbacher.org','mkaply%us.ibm.com','julien.pierre.boogz%sun.com','gerv%gerv.net','christophe.ravel.bugs%sun.com','alexei.volkov.bugs%sun.com',];
...
$super{'163'} = ['slavomir.katuscak%sun.com','neil.williams%sun.com','kaie%kuix.de','glen.beasley%sun.com','christophe.ravel.bugs%sun.com','alexei.volkov.bugs%sun.com','wtc%google.com','rrelyea%redhat.com','nelson%bolyard.com','julien.pierre.boogz%sun.com',];
$mode{'162'} = 'Open';
$branch{'162'} = 'HEAD';
$fullname{'162'} = 'P3P';
$mode{'209'} = 'Open';
