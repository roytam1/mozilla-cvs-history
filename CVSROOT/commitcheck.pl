...
$blessed{'166'} = ['scott%scott-macgregor.org','pinkerton%netscape.com','kerz%mozillazine.org','ian%hixie.ch','dbaron%dbaron.org','bryner%netscape.com','brendan%mozilla.org','asa%mozilla.org','bzbarsky%mit.edu',];
...
$blessed{'170'} = [];
$super{'170'} = ['kerz%mozillazine.org','bryner%netscape.com','scott%scott-macgregor.org','bienvenu%netscape.com',];
$mode{'160'} = 'Open';
$branch{'160'} = 'HEAD';
$fullname{'160'} = 'String';
$mode{'169'} = 'Open';
