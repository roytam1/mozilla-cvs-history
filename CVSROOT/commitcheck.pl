...
$blessed{'166'} = ['bryner%netscape.com','brendan%mozilla.org','ben%netscape.com','asa%mozilla.org','ian%hixie.ch','kerz%netscape.com','pinkerton%netscape.com',];
$super{'166'} = ['varga%netscape.com','mkaply%us.ibm.com','jaggernaut%netscape.com','hewitt%netscape.com','dean_tessman%hotmail.com','chanial%noos.fr','blakeross%telocity.com','hyatt%mozilla.org',];
$mode{'55'} = 'Open';
$branch{'55'} = 'HEAD';
...
$blessed{'170'} = [];
$super{'170'} = ['kerz%netscape.com','bryner%netscape.com','scott%scott-macgregor.org',];
$mode{'160'} = 'Open';
$branch{'160'} = 'HEAD';
$fullname{'160'} = 'String';
$mode{'169'} = 'Open';
