...
$super{'166'} = ['varga%netscape.com','mkaply%us.ibm.com','jaggernaut%netscape.com','hewitt%netscape.com','dean_tessman%hotmail.com','chanial%noos.fr','blakeross%telocity.com','hyatt%apple.com',];
$mode{'55'} = 'Open';
$branch{'55'} = 'HEAD';
...
$super{'164'} = ['hyatt%apple.com','sfraser%netscape.com','hewitt%netscape.com','ben%netscape.com','beard%netscape.com','pinkerton%netscape.com',];
$mode{'146'} = 'Restricted';
$branch{'146'} = 'NSPRPUB_PRE_4_2_CLIENT_BRANCH';
$fullname{'146'} = 'Client NSPR';
$blessed{'146'} = ['sfraser%netscape.com','lpham%netscape.com','jj%netscape.com','sdagley%netscape.com','gordon%netscape.com','beard%netscape.com','granrose%netscape.com',];
...
if (m:^embedding/browser/photon/.*$:) {return '113';}
