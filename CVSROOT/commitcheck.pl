...
$blessed{'146'} = ['smfr%smfr.org','seawood%netscape.com','sdagley%mac.com','mkaply%us.ibm.com','lpham%netscape.com','jje%mac.com','granrose%netscape.com','dbaron%dbaron.org','gerv%gerv.net',];
$super{'146'} = ['wtchang%redhat.com','darin%meer.net','cls%seawood.org','bryner%brianryner.com','leaf%mozilla.org',];
$mode{'96'} = 'Open';
$branch{'96'} = 'HEAD';
...
$blessed{'59'} = ['richm%netscape.com','cls%seawood.org',];
...
$blessed{'70'} = ['timeless%mozdev.org','mike%meer.net','cls%seawood.org','bratell%lysator.liu.se',];
...
$super{'145'} = ['ddrinan%netscape.com','tfox%netscape.com','saul.edwards%sun.com','nicolson%netscape.com','thayes%netscape.com','kaie%kuix.de','ian.mcgreer%sun.com','glen.beasley%sun.com','christophe.ravel.bugs%sun.com','bishakhabanerjee%netscape.com','julien.pierre.bugs%sun.com','nelsonb%netscape.com','wtchang%redhat.com','relyea%netscape.com',];
$mode{'151'} = 'Open';
$branch{'151'} = 'HEAD';
