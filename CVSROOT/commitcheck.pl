...
$blessed{'146'} = ['sdagley%netscape.com','sfraser%netscape.com','mkaply%us.ibm.com','lpham%netscape.com','jj%netscape.com','granrose%netscape.com','gordon%netscape.com','beard%netscape.com',];
$super{'146'} = ['darin%meer.net','wtc%netscape.com','seawood%netscape.com','leaf%mozilla.org',];
$mode{'96'} = 'Open';
$branch{'96'} = 'HEAD';
