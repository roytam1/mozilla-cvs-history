...
$blessed{'146'} = [];
$super{'146'} = ['larryh%netscape.com','wtc%netscape.com','cls%seawood.org','leaf%mozilla.org',];
$mode{'96'} = 'Open';
$branch{'96'} = 'HEAD';
...
$blessed{'112'} = ['warren%netscape.com','toshok%hungry.com','tague%netscape.com','slamm%netscape.com','shaver%mozilla.org','scc%netscape.com','ramiro%fateware.com','phillip%netscape.com','petitta%netscape.com','mcafee%netscape.com','kipp%netscape.com','jj%netscape.com','jim_nance%yahoo.com','Jerry.Kirk%Nexwarecorp.com','friedman%splode.com','endico%mozilla.org','donm%bluemartini.com','dmose%mozilla.org','dbaron%fas.harvard.edu','cls%seawood.org','bsharma%netscape.com','briano%netscape.com','braddr%puremagic.com','amasri%netscape.com','attinasi%netscape.com',];
...
$branch{'78'} = 'HEAD';
$fullname{'78'} = 'NSPR';
$blessed{'78'} = ['sdagley%netscape.com','scc%netscape.com','gordon%netscape.com','cyeh%bluemartini.com','cls%seawood.org','beard%netscape.com',];
