...
$blessed{'70'} = ['timeless%mozdev.org','gavin%gavinsharp.com','dbaron%dbaron.org','daumling%adobe.com','cls%seawood.org','bryner%brianryner.com','bratell%lysator.liu.se','bclary%bclary.com','bzbarsky%mit.edu',];
