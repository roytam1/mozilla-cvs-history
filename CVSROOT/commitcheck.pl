...
$super{'146'} = ['seawood%netscape.com','wtc%netscape.com','leaf%mozilla.org',];
$mode{'96'} = 'Open';
$branch{'96'} = 'HEAD';
...
$super{'78'} = ['cls%seawood.org','srinivas%netscape.com','wtc%netscape.com',];
$mode{'159'} = 'Open';
$branch{'159'} = 'HEAD';
...
$blessed{'145'} = ['jgmyers%netscape.com','jaggernaut%netscape.com','cotter%netscape.com','scc%mozilla.org','cls%seawood.org','bryner%netscape.com',];
