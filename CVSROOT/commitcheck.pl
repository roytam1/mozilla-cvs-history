...
$fullname{'138'} = 'Rhino';
$blessed{'138'} = [];
$super{'138'} = ['rogerl%netscape.com','mike+mozilla%meer.net','nboyd%atg.com','beard%netscape.com',];
$mode{'145'} = 'Restricted';
$branch{'145'} = 'HEAD';
