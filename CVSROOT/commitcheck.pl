...
$blessed{'146'} = ['sspitzer%mozilla.org','smfr%smfr.org','mozilla%weilbacher.org','mkaply%us.ibm.com','julien.pierre.bugs%sun.com','gerv%gerv.net','dbaron%dbaron.org','alexei.volkov.bugs%sun.com',];
