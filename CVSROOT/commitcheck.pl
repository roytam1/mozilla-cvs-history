...
$blessed{'166'} = ['scott%scott-macgregor.org','dbaron%dbaron.org','pinkerton%netscape.com','kerz%mozillazine.org','ian%hixie.ch','bryner%netscape.com','brendan%mozilla.org','asa%mozilla.org',];
$super{'166'} = ['varga%netscape.com','mkaply%us.ibm.com','jaggernaut%netscape.com','hewitt%netscape.com','dean_tessman%hotmail.com','chanial%noos.fr','blakeross%telocity.com','ben%netscape.com','hyatt%mozilla.org',];
$mode{'55'} = 'Open';
$branch{'55'} = 'HEAD';
...
$super{'164'} = ['hyatt%mozilla.org','sfraser%netscape.com','hewitt%netscape.com','ben%netscape.com','beard%netscape.com','pinkerton%netscape.com',];
$mode{'146'} = 'Restricted';
$branch{'146'} = 'NSPRPUB_PRE_4_2_CLIENT_BRANCH';
$fullname{'146'} = 'Client NSPR';
$blessed{'146'} = ['sfraser%netscape.com','sdagley%netscape.com','lpham%netscape.com','jj%netscape.com','granrose%netscape.com','gordon%netscape.com','beard%netscape.com','mkaply%us.ibm.com',];
...
$blessed{'59'} = ['seawood%netscape.com','richm%netscape.com','djani%netscape.com',];
...
$branch{'78'} = 'HEAD';
$fullname{'78'} = 'NSPR';
$blessed{'78'} = ['sonja.mirtitsch%sun.com','sfraser%netscape.com','sdagley%netscape.com','gordon%netscape.com','beard%netscape.com','kirk.erickson%sun.com',];
...
$blessed{'163'} = [];
$super{'163'} = ['mhein%sun.com','tfox%netscape.com','sonja.mirtitsch%sun.com','nicolson%netscape.com','nelsonb%netscape.com','kirk.erickson%sun.com','jpierre%netscape.com','javi%netscape.com','ian.mcgreer%sun.com','glen.beasley%sun.com','ddrinan%netscape.com','bishakhabanerjee%netscape.com','wtc%netscape.com','relyea%netscape.com',];
$mode{'159'} = 'Open';
$branch{'159'} = 'HEAD';
...
$blessed{'170'} = [];
$super{'170'} = ['kerz%mozillazine.org','bryner%netscape.com','scott%scott-macgregor.org',];
$mode{'160'} = 'Open';
$branch{'160'} = 'HEAD';
$fullname{'160'} = 'String';
$mode{'169'} = 'Open';
